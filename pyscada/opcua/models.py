...
class OPCUADevice(models.Model):
    ...
    path = models.CharField(default='/', max_length=254, help_text='Example: /hbk/clipx')
...
class OPCUAMethodArgument(models.Model):
    ...
    value = models.CharField(default='', max_length=254, blank=True, help_text="Enter a decimal value")
